...
# ---------- helper: mostrar conciliación (evita crash de Streamlit) ----------
def show_conciliacion(cuadra: bool):
    if cuadra:
...
def detect_bank_from_text(txt: str) -> str:
    ...
    # Prioridad: si parece GALICIA por su cabecera típica, devolver Galicia
